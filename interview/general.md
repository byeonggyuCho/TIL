...
### 퇴사한 이유가 뭔가요?
솔루션 관리를 하는 업무를 주 업무로 했는데 제 개발자 경험을 쌓는데 한계가 있다고 판단해서 퇴사했습니다.
...
### 가장 기억에 남는 프로젝트가 뭔가요?  
제 첫 프로젝트인 광주은행 모바일 웹 프로젝트에 참여했던게 가장 기억에 남습니다.  
제가 맡은 업무는 비대면 계좌 계설 서비스였는데 프로젝트를 진행하면서 고객과 협업하는 개발자들과 커뮤니케이션하는 것에 대해 깊게 고민했던 프로젝트였습니다.
