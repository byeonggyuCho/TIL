...
MVC 구조에서 프로그램의 모든 객체는 Model, View, 컨트롤러 중 하나 이어야합니다. 사용자는 view와 Interaction을 하고 View는 Model에 있는 데이터를 보여줍니다. controller는 이런 Interaction을 감시하며 필요할 때 view와 Model을 업데이트해야합니다.
